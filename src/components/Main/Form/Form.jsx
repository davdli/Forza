...
const Form = () => {
  ...
  return (
    <Grid container spacing={2}>
      ...
      <Button className={classes.button} fullWidth onClick={createInput} style={{color: "#f4f4f4", backgroundColor: 'rgba(38,39,43,0.8)', borderRadius: '6rem', boxShadow: '0 0 2rem rgba(0,0,0,0.4)'}}>Add To Category +</Button>
    </Grid>
  );
};
